<template>
	<nb-container>
		<header title="Isti'adzah dan Basmalah" :navigation="navigation"></header>
		<nb-content class="content">
			<cus-title>Cara Membaca Isti'adzah dan Basmalah</cus-title>
			...
			<nav-tool :navigation="navigation" prev="C3S2Content"></nav-tool>
		</nb-content>
