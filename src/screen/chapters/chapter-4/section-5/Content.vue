<template>
	<nb-container>
		<header title="Tajwid, Makhraj, dan Sifat-Sifat Huruf" :navigation="navigation"></header>
		<nb-content class="content">
			<cus-title>Sifat-Sifat Huruf yang Tidak Berlawanan</cus-title>
			...
			<nav-tool :navigation="navigation" prev="C4S4Content"></nav-tool>
		</nb-content>
